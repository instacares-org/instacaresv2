...
import { CreateBookingPaymentSchema, validateRequest } from '@/lib/api-validation';
...
export async function POST(request: NextRequest) {
  try {
    ...
    const validation = validateRequest(CreateBookingPaymentSchema, requestBody);

    if (!validation.success) {
      console.error('[SECURITY] Payment creation validation failed:', {
