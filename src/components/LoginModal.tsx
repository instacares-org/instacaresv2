  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (result.success) {
        ...
        // No need to redirect here - it's handled in AuthContext
      } else {
          ...
          <div className="mt-6 space-y-4">
            ...
            <SocialLogin
              ...
              onSocialLogin={(provider, userType) => {
                ...
                onClose();
                // Note: OAuth with redirect:true means this callback won't execute
                // The callbackUrl in SocialLogin handles the redirect to dashboard
              }}
            />
          </div>
