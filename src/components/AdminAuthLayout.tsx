...
interface AdminAuthLayoutProps {
  children: ReactNode;
  requiredPermission?: keyof NonNullable<AdminUser['permissions']>;
  title?: string;
  className?: string;
}
...
const AdminAuthLayout: React.FC<AdminAuthLayoutProps> = ({
  ...
  const handleLogout = async () => {
    try {
      // Use NextAuth signOut and redirect to logout page which clears all cookies
      window.location.href = '/logout?admin=true';
    } catch (error) {
