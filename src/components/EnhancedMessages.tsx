...
export default function EnhancedMessages({
  ...
  // Get socket connection status and online users
      ...
      <div className="p-3 border-b border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-900">
        <div className="flex items-center justify-between mb-3">
          <div className="flex items-center space-x-3">
            {/* User's own avatar with online status */}
            <div className="relative flex-shrink-0">
              ...
              {/* Online/Offline indicator for current user */}
              <div
                  ...
                  <div className="flex items-start space-x-2.5">
                    ...
                    <div className="relative flex-shrink-0">
                      ...
                      <div
                        ...
                        title={otherUser?.id && isUserOnline(otherUser.id) ? 'Online' : 'Offline'}
                      />
                      {/* Unread count indicator - top right */}
                      {room.unreadCount > 0 && (
