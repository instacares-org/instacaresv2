    ...
    <footer className="bg-gray-900 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          {/* Legal & Support */}
          <div>
            <h3 className="text-lg font-semibold mb-4">{t('footer.legalSupport')}</h3>
            <ul className="space-y-3 text-sm">
              <li>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            ...
            <div className="flex space-x-4">
              <div className="text-sm text-gray-400">
                {t('safety.followGuidelines')} • {t('safety.verifiedCaregivers')} • {t('safety.trustedPlatform')}
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="mt-6 pt-6 border-t border-gray-800">
          <div className="bg-gray-800 rounded-lg p-4">
            <p className="text-xs text-gray-400 text-center">
              <span className="font-semibold text-yellow-400">{t('safety.safetyFirst')}:</span> {t('safety.safetyNotice')}
            </p>
          </div>
        </div>
      </div>
